//package com.maple.scala3.macros.statements;
//
//import scala.quoted.*
...
//    '{new PreparedStatement[CallArgs[A]](UsafeStatement($sql))}.asExprOf[PreparedStatement[CallArgs[A]]]
//  }
//}
